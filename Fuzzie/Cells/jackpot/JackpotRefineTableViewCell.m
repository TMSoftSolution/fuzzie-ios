...
@implementation JackpotRefineTableViewCell
...
- (void)setCell:(NSDictionary *)dictionary{
    if (dictionary) {
        ...
        if ([[FZData sharedInstance].selectedJackpotRefineSubCategoryIds containsObject:dictionary[@"id"]]) {
