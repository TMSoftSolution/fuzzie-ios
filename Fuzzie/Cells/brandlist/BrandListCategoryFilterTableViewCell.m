//
//  BrandListCategoryFilterTableViewCell.m
//  Fuzzie
//
...
@implementation BrandListCategoryFilterTableViewCell
...
- (void)setCell:(NSDictionary *)dictionary{
    if (dictionary) {
        ...
        if ([[FZData sharedInstance].selectedCategoryIds containsObject:dictionary[@"id"]]) {
